        ...
        <img style="max-width:200px; margin-top: -46px;" src="/images/logo.png"> </a>
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-middle">
                        ...
                        <li> &nbsp;&nbsp;   </li>
                        <li><asp:Button Text ="Szukaj" style="margin-top:9px;" CssClass="btn btn-primary" Font-size="Larger"  runat="server" Width="110px" CausesValidation="false" PostBackUrl="~/Szukaj_log.aspx" /></li>
                    ...
                    <section class="panel">
                        ...
                        <div class ="panel-body">
                            ...
                            <div class="row">
                                <div class ="col-md-4 col-md-offset-1">
                                    <div class ="form-group">
                                        <asp:Label ID="check1" Text ="Nazwa firmy" runat="server" Visible="true"/>
                                ...
                                <div class ="col-md-4 col-md-offset-1">
                                    <div class ="form-group">
                                        <asp:Label Text="Rodzaj usług" runat="server">
                                        <asp:TextBox ID="TextBox_usl" runat="server" Enabled="true" CssClass="form-control input-sm" placeholder="Region działalności" Visible="true"/>
                            ...
                            <div class="row" >
                             <div class ="col-md-4 col-md-offset-1">
                                    <div class ="form-group">
                                         <asp:Label Text="Region działalności" runat="server">
                                         <asp:TextBox ID="TextBox_reg" runat="server" Enabled="true" CssClass="form-control input-sm" placeholder="Region działalności" Visible="true"/>
                                ...
                                <div class ="col-md-4 col-md-offset-1">
                                    <div class ="form-group">
                                         <asp:Label Text="Napisz coś o sobie:" runat="server">
                                         <asp:TextBox ID="TextBox1" runat="server" Enabled="true" CssClass="form-control input-sm" placeholder="Informacje" Visible="true" MaxLength="500" TextMode="MultiLine" />
