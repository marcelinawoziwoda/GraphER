<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="WebApplication4.About2" %>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                       ...
                       <h3>Szukasz specjalisty w dziedzinie grafiki? Fotografii? Może poszukujesz kamerzysty na swój ślub? Dzięki ogromnej bazie usługodawców - znajdziesz idealnego profesjonaliste!</h3>
                                                    <br />
                       <h3>Załóż konto, by w pełni cieszyć się wszystkimi możliwościami, jakie daje aplikacja!&nbsp;&nbsp;<asp:Button ID="Rejestracja_button" Text ="Zarejestruj się"  CssClass="btn btn-primary" PostBackUrl="~/Rejestracja.aspx" Font-size="Larger" runat="server" Width="225px"  /></h3>
                                              <br />
                        <h3>Jesteś już naszym użytkownikiem? Przejdź do logowania.&nbsp;&nbsp;<asp:Button ID="Button1" Text ="Zaloguj się"  CssClass="btn btn-primary" PostBackUrl="~/Logowanie.aspx" Font-size="Larger" runat="server" Width="225px"  /></h3>
                                              <br />
                                                    <br />
                                                    <br />
                         <h4>Masz pytania? <a href="Contact.aspx">Skontaktuj się z nami.</a></h4>
                         </div> 
                    </section>
                </div>
                </div>
